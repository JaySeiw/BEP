...
ObstacleMap=readmatrix('ObstacleMap.csv'); % Map of obstacles with [x1,y1,x2,y2]
...
while i<Nodes+1
    ...
    [intersection] = IntersectionDetector(Xnew, Ynew, Parent, RectangleMatrix, edges, Height, intersection, NodeMatrix);
